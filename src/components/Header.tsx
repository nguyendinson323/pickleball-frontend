...
const Header = () => {
  ...
  const navigation = [
    { name: 'Home', href: '/home', public: true },
      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex items-center space-x-2 hover:opacity-80 transition-opacity">
            ...
            <span className="text-xl font-bold text-gray-900 hidden sm:block">Pickleball Federation</span>
            <span className="text-lg font-bold text-gray-900 sm:hidden">PF</span>
          </Link>
