...
const SuperAdminDashboard = () => {
  ...
  const quickActions = [
    { name: 'User Management', icon: Users, href: '/super-admin/users', color: 'bg-blue-500' },
    { name: 'System Settings', icon: Settings, href: '/super-admin/system', color: 'bg-green-500' },
    { name: 'Analytics', icon: TrendingUp, href: '/super-admin/analytics', color: 'bg-purple-500' },
    { name: 'Global Settings', icon: Globe, href: '/admin/settings', color: 'bg-orange-500' }
  ];
