    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4 transition-all duration-500 hover:text-blue-600 hover:scale-105">
            Choose Your Account Type
          </h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto transition-all duration-500 hover:text-gray-800">
          ...
          {userTypes.map((userType, index) => {
            ...
            return (
              <div key={userType.type}>
                <div 
                  className={`card cursor-pointer transition-all duration-300 ease-out hover:shadow-2xl hover:scale-105 transform hover:-translate-y-1 bg-white rounded-lg shadow-lg border-2 p-6 ${
                    isSelected 
                      ? 'ring-4 ring-blue-500 bg-blue-50 scale-105 shadow-xl border-blue-300' 
                ...
                >
                  <div className="text-center pb-4">
                    ...
                    <h2 className={`text-xl font-semibold transition-all duration-300 ${
                      isSelected ? 'text-blue-700' : 'text-gray-900 hover:text-blue-600'
                    }`}>
                      {userType.title}
                    </h2>
                      ...
                      {userType.features.map((feature, featureIndex) => (
                        <li 
                          ...
                          className={`flex items-center text-sm transition-all duration-300 ${
                            isSelected ? 'text-blue-600' : 'text-gray-600 hover:text-blue-600'
                          }`}
                        >
                          <div className={`w-2 h-2 rounded-full ${userType.color} mr-3 transition-all duration-300 hover:scale-150 ${
        ...
        <div className="flex justify-between items-center max-w-md mx-auto">
          <button
            onClick={handleBack}
            className="flex items-center gap-2 px-4 py-2 border border-gray-300 rounded-md bg-white text-gray-700 hover:scale-105 hover:-translate-x-2 transition-all duration-300 hover:shadow-lg hover:bg-gray-100"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-md hover:scale-105 hover:translate-x-2 transition-all duration-300 hover:shadow-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Continue
            <svg className="w-4 h-4 transition-transform duration-300 group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
